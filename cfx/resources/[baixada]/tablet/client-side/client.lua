...
RegisterNUICallback("requestDrive",function(data,cb)
	...
	if distance <= 3 then
		...
		if driveIn then
			...
			TriggerEvent("Notify","importante","Teste iniciado, para finalizar saia do veículo.",5000)
		...
		TriggerEvent("Notify","importante","Dirija-se até a <b>Benefactor</b> para efetuar o teste.",2000)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHCREATE
