...
-----------------------------------------------------------------------------------------------------------------------------------------
local shopList = {
	{ -800.9,-1212.71,10.38,"departamentStore",true,false },
	...
	{ -785.94,-1221.91,6.86,"policeStore",false,false },

	{ 1837.85,3688.09,34.19,"policeStore",false,false },
	{ -449.72,6010.21,31.71,"policeStore",false,false },
	...
	{ 121.5,-1036.2,29.27,"beanMachine",false,false },
	{ 120.08,-1040.07,29.27,"beanMachine",false,false }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADTARGET
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("shops:openSystem",function(shopId)
	if shopList[shopId][6] then
		if GetClockHours() >= 15 and GetClockHours() <= 20 then
			...
			TriggerEvent("Notify","importante","Horário de funcionamento é das <b>15</b> ás <b>20</b> horas.",3000)
		end
	else
