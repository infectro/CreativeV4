...
AddEventHandler("homes:togglePropertys",function()
	if homes["blips"] then
		homes["blips"] = false
		TriggerEvent("Notify","importante","Marcações desativadas.",3000)
		...
		TriggerEvent("Notify","importante","Marcações ativadas.",3000)
		...
		while true do
			...
			if IsControlJustPressed(1,38) then
				...
				if homes["garage"] <= 1 then
					...
					TriggerEvent("Notify","sucesso","Garagem adicionada.",10000)
