	...
	if user_id then
		if vRP.hasGroup(user_id,"Suporte") and parseInt(args[1]) > 0 and parseInt(args[2]) > 0 then
			...
			if identity then
				...
				TriggerClientEvent("Notify",source,"importante","Passaporte <b>"..nuser_id.."</b> banido por <b>"..days.." dias.",5000)
			end
		end
	end
end)
	...
	if user_id then
		if vRP.hasGroup(user_id,"Suporte") and parseInt(args[1]) > 0 then
			...
			if identity then
				...
				TriggerClientEvent("Notify",source,"sucesso","Passaporte <b>"..nuser_id.."</b> desbanido.",5000)
			end
		end
	end
end)
...
RegisterCommand("group",function(source,args,rawCommand)
	...
	if user_id then
		--if vRP.hasGroup(user_id,"Moderador") and parseInt(args[1]) > 0 and args[2] then
			TriggerClientEvent("Notify",source,"sucesso","Adicionado <b>"..args[2].."</b> ao passaporte <b>"..args[1].."</b>.",5000)
...
RegisterCommand("ungroup",function(source,args,rawCommand)
	...
	if user_id then
		if vRP.hasGroup(user_id,"Moderador") and parseInt(args[1]) > 0 and args[2] then
			TriggerClientEvent("Notify",source,"sucesso","Removido <b>"..args[2].."</b> ao passaporte <b>"..args[1].."</b>.",5000)
