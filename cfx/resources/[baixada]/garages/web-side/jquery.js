	...
	$.post("http://garages/myVehicles",JSON.stringify({}),(data) => {
		...
		$("#displayHud").html(`
				...
				${nameList.map((item) => (`
					<div class="item vehicle" data-name="${item.name}">
							<div class="item-photo" style="
								...
								background-image: url(http://45.162.228.208/baixada/cars/${item.name2}.png);
							">
							<div class="name-veh">
								<small>veiculo</small>
			...
			<footer>
				...
				<p>Mantenha a sua taxa paga em dia<br>
					ou você não poderá retirar o seu veículo.</p>
			</footer>
			<div class="btns">
				...
				<button id="storeVehicle">
					<span>guardar</span>
					<small>veiculo proximo</small>
				</button>
			</div>
		`);
	});
