...
local garageLocates = {
	...
	["62"] = { x = 1856.95, y = 3683.82, z = 34.27,
		["1"] = { 1853.74,3675.92,33.41,212.6 },
		["2"] = { 1850.5,3674.06,33.43,209.77 },
		["3"] = { 1847.21,3672.24,33.38,209.77 }
	},
	["61"] = { x = -777.44, y = -1276.37, z = 5.14, ---777.44,-1276.37,5.14,189.93
		["1"] = { -778.69,-1280.72,5.0,172.92 }
	},
...
function cRP.spawnPosition()
	...
	if garageLocates[openGarage][tostring(checkSlot)] == nil then
		TriggerEvent("Notify","importante","Vagas estão ocupadas.",5000)
