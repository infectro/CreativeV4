...
local pedList = {
	...
	{ -- Marabunta
		distance = 10,
		coords = { 1405.52,-1540.32,54.71,235.28 },
		model = { 0xE52E126C,"ig_ramp_gang" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Vagos
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { -166.7,-301.58,39.73,252.29 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { -1197.34,-779.01,17.32,31.19 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
		distance = 15,
		coords = { -1447.62,-239.77,49.81,42.52 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { 123.16,-212.3,54.56,252.29 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
		distance = 15,
		coords = { 621.25,2753.33,42.09,93.55 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { -3172.39,1055.33,20.86,246.62 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Motorsport
		distance = 30,
		coords = { -56.39,-1098.58,26.42,34.02 },
		model = { 0xC314F727,"cs_gurk" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	}
}
