...
Citizen.CreateThread(function()
	while true do
		local timeDistance = 999
		if (celular or animActived) and playerActive then
			timeDistance = 1
...
RegisterCommand("cRhandsup",function(source,args)
	local ped = PlayerPedId()
	if not IsPauseMenuActive() and not exports["inventory"]:blockInvents() and not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not IsPedInAnyVehicle(ped) and not celular and GetEntityHealth(ped) > 101 and not cancelando and playerActive then
...
RegisterCommand("cRpoint",function(source,args)
	local ped = PlayerPedId()
	if not IsPauseMenuActive() and not exports["inventory"]:blockInvents() and not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not cancelando and not celular and not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 101 and playerActive then
...
-- LIGARVEH
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("cRengine",function(source,args)
	if GetGameTimer() >= cdBtns and playerActive then
		cdBtns = GetGameTimer() + 1000
...
-- AGACHAR
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("cRcrouch",function(source,args)
	if GetGameTimer() >= cdBtns and playerActive then
		cdBtns = GetGameTimer() + 1000

		local ped = PlayerPedId()
		if not IsPauseMenuActive() and not exports["inventory"]:blockInvents() and not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not celular and GetEntityHealth(ped) > 101 and not cancelando then
			if not IsPedInAnyVehicle(ped) and not blockDrunk then
...
RegisterCommand("cRbind",function(source,args)
	if GetGameTimer() >= cdBtns and playerActive then
		...
		local ped = PlayerPedId()
		if not IsPauseMenuActive() and not exports["inventory"]:blockInvents() and not exports["player"]:blockCommands() and not celular and GetEntityHealth(ped) > 101 and not cancelando then
...
RegisterKeyMapping("cRcrouch","Agachar","keyboard","LCONTROL")
