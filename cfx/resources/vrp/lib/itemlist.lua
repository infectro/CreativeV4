...
local itemlist = {
	...
	["weaponfragment"] = {
		["index"] = "weaponfragment",
		["name"] = "Fragmento de Arma",
		["desc"] = "Utilizado para criação de Armas.",
		["type"] = "Comum",
		["weight"] = 0.05
	},
	["ammofragment"] = {
		["index"] = "ammofragment",
		["name"] = "Fragmento de Munição",
		["desc"] = "Utilizado para criação de Munições.",
		["type"] = "Comum",
		["weight"] = 0.05
	},
	["drugsfragment"] = {
		["index"] = "drugsfragment",
		["name"] = "Fragmento de Droga",
		["desc"] = "Utilizado para criação de Drogas.",
		["type"] = "Comum",
		["weight"] = 0.05
	},
	["hackingfragment"] = {
		["index"] = "hackingfragment",
		["name"] = "Fragmento de Hacking",
		["desc"] = "Utilizado para Hacking.",
		["type"] = "Comum",
		["weight"] = 0.05
	},
	["washfragment"] = {
		["index"] = "washfragment",
		["name"] = "Fragmento de Lavagem",
		["desc"] = "Utilizado para Lavagem de Dinheiro.",
		["type"] = "Comum",
		["weight"] = 0.05
	},
	["weapontable"] = {
		...
		["desc"] = "Utilizada para criação de Armas.",
		["type"] = "Usável",
		["durability"] = 15,
		["weight"] = 15.00
	},
	["ammotable"] = {
		["index"] = "ammotable",
		["name"] = "Mesa de Criação",
		["desc"] = "Utilizada para criação de Munição.",
		["type"] = "Usável",
		["durability"] = 15,
		["weight"] = 15.00
	},
...
-- ITEMILLEGAL
-----------------------------------------------------------------------------------------------------------------------------------------
function itemIllegal(nameItem)
	local splitName = splitString(nameItem,"-")

	if itemlist[splitName[1]] then
		return itemlist[splitName[1]]["illegal"] or false
	end
